...
document.getElementById('pageLogo').innerHTML = "Shop the edit";
...
//     document.getElementsByClassName('categoryItem')[i].style.display = 'none';
//    }
   for(var i = 0 ;i<categories.length; i++){
    document.getElementsByClassName('categoryItem')[i].style.display = 'block';
    document.getElementsByClassName('newArrivalSection')[i].innerHTML = categories[i];
   }
...
for(var i = 0 ;i<(categories.length)*4; i++){
