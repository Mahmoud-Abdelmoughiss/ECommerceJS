...
document.getElementById('searchInput').addEventListener('input',function(){
    ...
    for(var i = 0; i<productName.length ;i++){
        ...
        if(test){
            searchList[searchList.length] = i;
        }
        console.log(test);
    }

    for(var i =0 ;i<searchList.length;i++){
        document.getElementsByClassName('imageProductSearched')[i].src = productImages[searchList[i]];
        document.getElementsByClassName('productNameSearch')[i].innerText = productName[searchList[i]];
        document.getElementsByClassName('productPriceSearch')[i].innerHTML = productPrice[searchList[i]]+' L.E';
        document.getElementsByClassName('itemSearch')[i].style.display ='block';
    }
